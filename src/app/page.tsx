...
async function FeedGrid() {
  ...
  try {
    ...
    privateJobs = await getPosts('aziz_privatejob', 4);
    wfhJobs = await getPosts('aziz_wfh', 4);
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
      ...
      />
      <FeedCard title="Private Jobs" typeSlug="private-jobs" posts={privateJobs} accentColor="text-indigo-400"
      ...
      />
      <FeedCard title="Work From Home" typeSlug="work-from-home" posts={wfhJobs} accentColor="text-teal-400"
