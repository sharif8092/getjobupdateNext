        ...
        <div className="bg-slate-900 w-full pt-16 pb-28 md:pb-36 relative overflow-hidden">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <nav aria-label="Breadcrumb" className="flex items-center justify-center gap-1.5 text-[11px] font-black uppercase text-slate-400 mb-6 tracking-widest">
              ...
              <span>›</span>
              <Link prefetch={false} href="/qualification" className="hover:text-orange-500 transition-colors">QUALIFICATIONS</Link>
              <span>›</span>
            ...
            <div className="mt-8 pt-8 border-t border-slate-100">
              ...
              <div className="flex flex-wrap gap-2.5">
                {QUALIFICATIONS_LIST.slice(0, 8).map((q) => (
                  <Link prefetch={false} key={q.slug} href={`/qualification/${q.slug}`} className="inline-block px-3 py-1.5 bg-slate-50 text-slate-600 text-xs font-bold rounded-lg hover:bg-orange-50 hover:text-orange-600 transition-colors border border-slate-200 hover:border-orange-200">{q.name} Jobs</Link>
                ))}
              </div>
            </div>
          </div>
