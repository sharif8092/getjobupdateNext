...
export async function getPosts(
  ...
  try {
    ...
    // Minimal fields for list pages — strip seo_meta, excerpt, faq, howto to reduce RSC payload
    const fields = 'id,date,modified,slug,status,type,link,title,custom_meta,job_category,job_state';
